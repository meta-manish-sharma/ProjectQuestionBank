...
<script type="text/javascript" src="js/search-tag.js"></script>
...
<body>
	...
	<div class="container content-wrapper">
		...
		<ul class="nav nav-pills">
			<li class="active"><a data-toggle="pill" href="#pill1" >Popular </a></li>
			<li><a data-toggle="pill" href="#pill2" onclick="getTagList('Name','tagTemp','${noOfPages}','1')"> Name </a></li>
		
		</ul>
		<div class="tab-content">
		<div id="pill1" class="tab-pane fade in active">
		
		<h4 class="section-heading">Popular Tags</h4>
		
			<c:forEach items="${tagList}" var="current">
				<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 user-card" >
					<h4>Name:<a href="listQuestion.do?tagId=${current.tagId }&page=1"> <c:out value="${current.tagName}"></c:out></a></h4>
									...
									<tr>
										<c:if test="${currentPage != 1}">
											<td class="page-number-td"><a
												href="getTag.do?page=${currentPage - 1}"
